        ...
        <style>
            ...
            * {
            ...
            .u-avatar {
                ...
                height:36px;
                border-radius:50%;
                background:linear-gradient(135deg,var(--purple),#9B72E8);
                display:flex;
                align-items:center;
                justify-content:center;
                font-size:0.85rem;
    ...
    <body>
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="admin/administrator.jsp" class="s-link"><i class="bi bi-grid-1x2-fill"></i> Dashboard</a>
                <div class="nav-section-label">Quản lý</div>
                <a href="mainController?action=manageUsers" class="s-link active"><i class="bi bi-people-fill"></i> Quản lý Users</a>
        ...
        <div class="main">
            <div class="topbar">
                <div class="topbar-title">Quản lý Users</div>
            ...
            <div class="page-content">
                <div class="breadcrumb-bar">
                    ...
                    <i class="bi bi-chevron-right"></i><span>Quản lý Users</span>
                </div>

                <div class="search-bar">
                    <div class="count-label">
                        Tổng: <strong id="countDisplay">${not empty USER_LIST ? USER_LIST.size() : 0}</strong> users
                    </div>
                </div>
                                ...
                                <tr>
                                    <td>
                                        <div style="display:flex;align-items:center;gap:10px;">
                                            <div class="u-avatar">${fn:substring(u.fullname,0,1)}</div>
                                            <div>
                                                <div style="font-weight:700;font-size:0.87rem;">${u.fullname}</div>
                                                <div style="font-size:0.7rem;color:#9B72E8;font-weight:600;">#${u.userId}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${u.role == 1}"><span class="badge-role role-admin">Admin</span></c:when>
                                            <c:when test="${u.role == 2}"><span class="badge-role role-instructor">Instructor</span></c:when>
                                            <c:otherwise><span class="badge-role role-student">Student</span></c:otherwise>
                                        </c:choose>
                                    </td>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${u.status}">
                                                <a href="${pageContext.request.contextPath}/adminController?action=blockUser&userId=${u.userId}"
                                                   class="btn-sm btn-block-u"
                                                   onclick="return confirm('Block user ${u.fullname}?')">
                                                    <i class="bi bi-slash-circle"></i> Block
                                                </a>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="${pageContext.request.contextPath}/adminController?action=unblockUser&userId=${u.userId}"
                                                   class="btn-sm btn-unblock-u"
