                        ...
                        <c:forEach var="w" items="${wishlist}" varStatus="st">
                            <div class="wish-card" id="card-${w.wishlistId}" style="animation-delay: ${st.index * 0.06}s">
                                ...
                                <div class="wish-card-actions">
                                    <c:choose>
                                        <c:when test="${fn:contains(enrolledIds.toString(), w.courseId)}">
                                            <%-- Đã enroll → vào học --%>
                                        ...
                                        <c:otherwise>
                                            <%-- Chưa enroll → mở modal đăng ký --%>
                                            <button type="button" class="btn-enroll"
                                                    onclick="openModal('${w.courseId}', 'Khóa học #${w.courseId}', '${feeMap[w.courseId]}', '${sessionScope.user.balance}')">
