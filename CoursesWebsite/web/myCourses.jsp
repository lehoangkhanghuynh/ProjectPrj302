                                        ...
                                        <c:otherwise>
                                            <span class="card-fee ${course.fee == 0 ? 'free' : ''}">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <fmt:formatNumber value="${course.fee}"
                                                                          type="number"
                                                                          groupingUsed="true"
                                                                          maxFractionDigits="0"/> ₫
                                                    </c:otherwise>
        ...
        <script>
            function filterTab(el, type) {
                ...
                document.querySelectorAll('.course-card').forEach(card => {
                    ...
                    else if (type === 'done') card.dataset.status === 'done' ? card.classList.remove('hidden') : card.classList.add('hidden');
                    else card.dataset.status === 'progress' ? card.classList.remove('hidden') : card.classList.add('hidden');
                });
            }
