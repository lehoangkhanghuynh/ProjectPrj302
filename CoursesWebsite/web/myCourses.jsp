...
<head>
    ...
    <title>Khóa học của tôi - KKKAcademy</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* NAVBAR */
        .navbar-main {
            background: var(--purple-deep); padding: 0 48px; height: 68px;
        ...
        .page-header {
            ...
            padding: 52px 80px 56px; position: relative; overflow: hidden;
        }
        ...
        .card-progress-fill { height: 100%; background: linear-gradient(90deg, var(--purple-mid), var(--gold)); width: 40%; border-radius: 0 2px 2px 0; }
                ...
                <div class="course-grid">
                    <c:forEach var="course" items="${MY_COURSES}" varStatus="st">
                        <div class="course-card">
                            ...
                            <!-- Body -->
                            <div class="card-body">
                                <div class="card-org"><i class="bi bi-building"></i> KKKAcademy</div>
    ...
    <footer>
        <div class="footer-inner">
            <span style="font-family:'Playfair Display',serif;font-size:1.2rem;font-weight:700;color:#fff;">
                KKK<span style="color:var(--gold);">Academy</span>
            </span>
