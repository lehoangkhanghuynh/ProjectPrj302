...
<body>
    ...
    <a href="${pageContext.request.contextPath}/courseController?action=ExploreCourse" class="brand-top">DUK<span>Academy</span></a>
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <div class="review-block">
                    ...
                    <form method="POST" action="${pageContext.request.contextPath}/reviewController">
                        <input type="hidden" name="action"   value="add">
                        <input type="hidden" name="courseId" value="${courseId}">
<input type="hidden" name="redirect" value="${pageContext.request.contextPath}/courseController?action=courseComplete&courseId=${courseId}">
        ...
        <div class="action-buttons">
            <a href="${pageContext.request.contextPath}/certificateController?action=certificate&courseId=${courseId}" class="btn-cert">
            ...
            <div class="btn-row">
                ...
                <a href="${pageContext.request.contextPath}/course/myCourses" class="btn-mycourses">
