        ...
        <style>
            ...
            *, *::before, *::after {
            ...
            .value-card:hover {
                ...
                box-shadow: 0 10px 28px rgba(108,63,197,0.12);
            }
            ...
            .team-card:hover {
                ...
                box-shadow: 0 16px 40px rgba(108,63,197,0.13);
            }
            .team-avatar {
                width: 90px;
                height: 90px;
                ...
                box-shadow: 0 4px 16px rgba(108,63,197,0.15);
            }
            .team-avatar img {
                width: 100%;
                height: 100%;
            ...
            .av-gold   {
                background: linear-gradient(135deg, #b8851a, var(--gold));
            }
            .av-teal   {
                background: linear-gradient(135deg, #0d5c63, #1a9aa0);
            }
            .team-name {
                font-size: 1rem;
                font-weight: 700;
            ...
            .why-card:hover {
                ...
                box-shadow: 0 8px 28px rgba(108,63,197,0.1);
            }
            .why-icon {
                width: 50px;
                height: 50px;
            ...
            @media (max-width: 1000px) {
                ...
                .about-hero, .mission, .story, .team, .why, .cta-join, footer {
                    padding-left: 24px;
                    padding-right: 24px;
                }
                .stats-bar {
    ...
    <body>
        ...
        <c:if test="${sessionScope.user != null}">
            <section class="cta-join">
                ...
                <div class="cta-btns">
                    <a href="mainController?action=ExploreCourse" class="btn-cta-primary"><i class="bi bi-play-fill"></i> Khám phá khóa học</a>
