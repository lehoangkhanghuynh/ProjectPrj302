...
<head>
    ...
    <title>Nạp tiền - KKKAcademy</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header-sub { font-size: 0.875rem; color: rgba(255,255,255,0.6); }
        ...
        .amount-label { font-size: 0.8rem; color: rgba(255,255,255,0.55); font-weight: 500; }
        .amount-value { font-size: 1.5rem; font-weight: 700; color: var(--gold); }
        ...
        .quick-btn:hover { border-color: var(--purple); color: var(--purple); background: var(--purple-light); }
        .quick-btn.active { border-color: var(--purple); color: var(--purple); background: var(--purple-light); }
        ...
        .method-tab:hover { border-color: var(--purple); }
        .method-tab.active { border-color: var(--purple); background: var(--purple-light); }
        .method-tab .tab-icon { font-size: 1.4rem; margin-bottom: 4px; }
        .method-tab .tab-label { font-size: 0.75rem; font-weight: 700; color: var(--text); }
        ...
        .btn-momo:hover { transform: translateY(-2px); box-shadow: 0 8px 28px rgba(174,32,112,0.4); }
        .btn-momo:active { transform: translateY(0); }
        ...
        .btn-qr:hover { background: var(--purple-light); transform: translateY(-2px); }
        ...
        .qr-title { font-size: 0.82rem; font-weight: 700; color: var(--muted); margin-bottom: 14px; text-transform: uppercase; letter-spacing: 1px; }
        .qr-img { width: 220px; height: 220px; border-radius: 12px; border: 3px solid var(--purple); padding: 6px; background: #fff; }
        .qr-info { margin-top: 14px; font-size: 0.8rem; color: var(--muted); line-height: 1.7; }
        ...
        footer span { font-size: 0.75rem; color: rgba(255,255,255,0.3); }
