    ...
    <body>
        ...
        <nav class="navbar-main" style="position:relative;">
            ...
            <ul class="nav-links">
                ...
                <li><a href="${pageContext.request.contextPath}/about.jsp">Thông tin Chung</a></li>Thông tin Chung</a></li>
            ...
            <div class="nav-right">
                ...
                <div class="dropdown-menu-custom" id="userDD">
                    ...
                    <a href="${pageContext.request.contextPath}/course/myCourses"><i class="bi bi-book"></i> Khóa học của tôi</a>
                    ...
                    <div class="cert-grid">
                        ...
                        <c:forEach var="c" items="${certList}">
                            ...
                            <div class="cert-card">
                                ...
                                <a class="btn-view"
                                   href="${pageContext.request.contextPath}/mainController?action=certificate&courseId=${c.courseId}">
                                    Xem chứng chỉ
                                </a>
