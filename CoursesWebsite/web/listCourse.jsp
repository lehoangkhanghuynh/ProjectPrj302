    ...
    <head>
        ...
        <style>
            ...
            *, *::before, *::after {
            ...
            .btn-wishlist.in-wish {
                color: #E53935;
            }
            .btn-wishlist:not(.in-wish) {
                color: #bbb;
            }
            ...
            .modal-info-value.fee-val     {
                color: var(--purple);
                font-size: 1rem;
            }
            .modal-info-value.balance-val {
                color: #2E7D32;
            }
            .modal-info-value.after-val   {
                color: var(--gold);
            }
            .modal-info-value.danger-val  {
                color: #C62828;
            }
            .modal-divider {
                height: 1px;
            ...
            @media (max-width: 900px) {
                ...
                .main-content, .page-header, .filter-bar {
                    padding-left: 20px;
                    padding-right: 20px;
                }
                .navbar-main {
    ...
    <body>
        ...
        <script>
                    ...
                    function applyFilters() {
                        ...
                        if (b)
                            b.textContent = visible + ' khóa học';
                    }
        </script>
    </body>
</html>
