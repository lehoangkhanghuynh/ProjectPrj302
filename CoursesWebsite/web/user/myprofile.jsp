...
<html lang="vi">
    ...
    <body>
        ...
        <nav class="navbar-main" style="position:relative;">
            ...
            <div class="nav-right">
                ...
                <div class="dropdown-menu-custom" id="userDD">
                    <a href="${pageContext.request.contextPath}/mainController?action=viewProfile">
                        <i class="bi bi-person"></i> Hồ sơ của tôi
                    </a>            <a href="${pageContext.request.contextPath}/course/myCourses"><i class="bi bi-book"></i> Khóa học của tôi</a>
                ...
                <form action="${pageContext.request.contextPath}/mainController" method="POST">
                    ...
                    <div class="field-row cols-3" style="margin-bottom:16px;">
                        ...
                        <div class="actions-row">
                            ...
                            <a href="${pageContext.request.contextPath}/homePage.jsp" class="btn-ghost"><i class="bi bi-arrow-left"></i> Quay lại</a>
                    </div>
                </form>
        ...
        <script src="${pageContext.request.contextPath}/assets/js/myprofile.js" type="text/javascript"></script>
